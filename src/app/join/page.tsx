  ...
  return (
    <div className="relative min-h-screen overflow-hidden scroll-smooth py-12 px-4">
      ...
      <motion.div 
        ...
        style={{ opacity: 0 }}
      >
        <h1 className="text-4xl playfair-heading font-extrabold md:text-5xl mb-6 text-midnight-800">
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
        ...
        >
          <div className="space-grotesk-section flex flex-col h-full">
      ...
      >
        <div className="space-grotesk-section">
          <h2 className="text-2xl font-heading playfair-heading font-semibold mb-6 text-midnight-800">
            Follow Us
          </h2>
