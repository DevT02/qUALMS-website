    ...
    <div className="relative overflow-hidden scroll-smooth">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <section className="mb-12 sm:mb-16 max-w-3xl">
          <h2 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">MSULC 2025</h2>
          ...
          <div className="p-5 sm:p-6 bg-slate-300/40 rounded-lg shadow border border-ice-100/10">
            <h3 className="text-2xl font-heading font-bold mb-4 text-lavender">Conference at a Glance</h3>
        ...
        <section id="winners" className="mb-12 sm:mb-16">
          <h2 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">MSULC 2025 Winners</h2>
          <div className="p-5 sm:p-6 bg-slate-300/40 rounded-lg shadow border border-ice-100/10">
            <p className="text-lg font-heading text-neutral-800 dark:text-neutral-200 mb-4">Congratulations to the winners of MSULC 2025!</p>
        ...
        <section id="resources" className="mb-12 sm:mb-16">
          <h2 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">Post-event materials</h2>
          <div className="p-5 sm:p-6 bg-slate-300/40 rounded-lg shadow border border-ice-100/10">
            <div className="mt-4">
        ...
        <section className="mb-12 sm:mb-16">
          <h2 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">WHY MSULC?</h2>
          <p className="text-xl font-heading text-neutral-800 dark:text-neutral-200 leading-relaxed">
        ...
        <section className="mb-14 sm:mb-20">
          ...
          <div className="p-5 sm:p-7 bg-slate-300/40 rounded-lg shadow-lg border border-ice-100/10">
            <h4 className="text-2xl font-heading font-bold text-lavender mb-6">MSULC 2025 Tentative Schedule</h4>
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row border-b border-lavender/20 pb-3">
                <div className="font-heading font-bold text-midnight-800 sm:w-32 mb-2 sm:mb-0">11:00 - 11:15</div>
                <div className="flex-1 font-heading font-medium">Opening Ceremony</div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-lavender/20 pb-3">
                <div className="font-heading font-bold text-midnight-800 sm:w-32 mb-2 sm:mb-0">11:20 - 12:50</div>
                <div className="flex-1">
                  <span className="font-heading font-medium">Poster Session #1</span>
                  <div className="text-sm font-heading mt-1">Poster presentations and judging. Lunch will be provided during this time.</div>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-lavender/20 pb-3">
                <div className="font-heading font-bold text-midnight-800 sm:w-32 mb-2 sm:mb-0">1:00 - 2:30</div>
                <div className="flex-1">
                <span className="font-heading font-medium">Keynote Speaker Talk with Maziar Toosarvandani at Wells Hall B342</span>
                  {/* Add abstract in a styled box */}
                  <div className="mt-2 p-4 bg-lavender/5 border-l-4 border-lavender rounded-r-lg">
                    <h5 className="font-heading font-semibold text-lavender mb-2">Abstract: Animacy in the grammar: The view from Zapotec</h5>
              ...
              <div className="flex flex-col sm:flex-row border-b border-lavender/20 pb-3">
                <div className="font-heading font-bold text-midnight-800 sm:w-32 mb-2 sm:mb-0">2:45 - 4:15</div>
                <div className="flex-1">
                  <span className="font-heading font-medium">Poster Session #2</span>
                  <div className="text-sm font-heading mt-1">Poster presentations and judging. Snacks and refreshments will be provided.</div>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row border-b border-lavender/20 pb-3">
                <div className="font-heading font-bold text-midnight-800 sm:w-32 mb-2 sm:mb-0">4:30 - 4:45</div>
                <div className="flex-1">
                  <span className="font-heading font-medium">Closing Ceremony & Awards</span>
                  <div className="text-sm font-heading mt-1">Award details to be announced soon!</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10 sm:mb-12">
          <h2 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">WHAT IS THE POSTER COMPETITION?</h2>
          <p className="text-xl font-heading text-neutral-800 dark:text-neutral-200">
        ...
        <section className="mb-10 sm:mb-12">
          <h3 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">WHAT SHOULD THE POSTER BE?</h3>
          <p className="text-xl font-heading text-neutral-800 dark:text-neutral-200">
        ...
        <section className="mb-10 sm:mb-12">
          <h3 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">HOW DOES THE COMPETITION WORK?</h3>
          <p className="text-xl font-heading text-neutral-800 dark:text-neutral-200">
        ...
        <section className="mb-10 sm:mb-12">
          <h3 className="text-3xl font-heading font-semibold text-neutral-900 dark:text-neutral-100 mb-5">HAVE FUN!</h3>
          <p className="text-xl font-heading text-neutral-800 dark:text-neutral-200">
